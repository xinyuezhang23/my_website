---
title: "Pre course assignment of Applied Statics"
date: '2017-10-31T22:42:51-05:00'
description: This is a pre course homework of Applied Statics. In this file, we need to complete software installation, demonstrate competency in Markdown, and in the basics of ggplot.
draft: no
image: trees.jpg
keywords: ''
slug: xinyue
...
1. Undergraduate : [Shanghai University of Finance and Economics](https://english.sufe.edu.cn/), School of Information Management and Engineering 
2. Graduate : London Business School
3. Hometown: Changchun, China
4. Birthday: March 7,1999

As for work experience, I have great passion in product management and data analysis. Please refer to my [LinkedIn Profile](https://www.linkedin.com/in/xinyue-zhang-9942aa155/)for more details.

This is the photo of LBS campus.
```{r picture1, echo=FALSE, out.width="100%"}
knitr::include_graphics("/img/Campus.jpg", error = FALSE)
```
